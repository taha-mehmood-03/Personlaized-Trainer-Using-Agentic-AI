...
class TwilioWhatsAppCrisisService:
    ...
    def __init__(self):
        ...
        if not self.account_sid or not self.auth_token:
            print("⚠️ [TWILIO] Primary credentials not found, trying fallback...")
        ...
        if not all([self.account_sid, self.auth_token]):
            print("⚠️ [TWILIO] Credentials not configured in .env")
        ...
        try:
            ...
            if user_details:
                try:
                    ...
                    print(f"[TWILIO-WHATSAPP] ⚠️ Error encoding user details: {e}")
            ...
            try:
                ...
                print(f"[TWILIO-WHATSAPP] ⚠️ Error encoding final message: {e}")
            ...
            try:
                ...
                print(f"[TWILIO-WHATSAPP] ⚠️ WhatsApp failed ({wa_err.__class__.__name__}): {str(wa_err)[:120]}")
        ...
        try:
            ...
            if city or region or country:
                try:
                    ...
                    print(f"[TWILIO-LOC] ⚠️ Error encoding location: {e}")
                    location_details = "📌 LOCATION: Location data unavailable\n"
            
            level_icon = "🚨" if crisis_level == "high" else "⚠️"
            level_label = "HIGH 🛑" if crisis_level == "high" else "MEDIUM ⚠️"
            ...
            if method == "GPS":
                ...
                gps_notice = "⚠️ This is an IP-based fallback location (±500 km accuracy). GPS was denied/unavailable.\n\n"
            ...
            try:
                ...
                print(f"[TWILIO-LOC] ⚠️ Error encoding message body: {e}")
            ...
            if method == "GPS":
                ...
                print(f"[TWILIO-LOC] ⚠️  USING IP-BASED FALLBACK (±500km accuracy - user denied GPS)")
            ...
            try:
                ...
                print(f"[TWILIO-LOC] ⚠️ Error encoding message: {e}")
            ...
            try:
                ...
                print(f"[TWILIO-LOC] ⚠️ WhatsApp failed ({wa_err.__class__.__name__}): {str(wa_err)[:120]}")
